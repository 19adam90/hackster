...
proc create_root_design { parentCell } {
  ...
  set lcd_out_0 [ create_bd_port -dir O -from 7 -to 0 lcd_out_0 ]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_reset [get_bd_pins main_0/reset] [get_bd_pins rst_ps7_0_50M/peripheral_reset]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins main_0/dat_in] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins main_0/dp] [get_bd_pins xlslice_1/Dout]
